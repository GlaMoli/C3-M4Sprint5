...
const CountryCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createCountry({
        nombre,
        capital: capital.split(',').map((c) => c.trim()), // array de capitales
        continente,
      ...
      console.error('Error creando país:', err)
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-800">
      <div className="max-w-md w-full p-6 rounded">
        <h2 className="text-2xl font-bold mb-4 text-white">Crear nuevo País</h2>
